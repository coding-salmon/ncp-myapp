...
function getStudent(e) {
  ...
  fetch("../students/" + no)
    ...
    .then((result) => {
      ...
      if (student.photo) {
        document.querySelector("#f-photo-origin").href = `https://kr.object.ncloudstorage.com/ncp08-bucket-0329-member-photo/${student.photo}`;
        document.querySelector("#f-photo").src = `https://gtumxlxq3591.edge.naverncp.com/xYEMUWGzS1/5570c8c5-2cf8-47f7-9b35-3284b22af7f2/${student.photo}?type=f&w=80&h=80&faceopt=true&ttype=jpg`;
      } /*else {
